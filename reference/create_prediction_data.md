...
This function creates predictors data based on spatial inputs or loads
cached predictors data if the file already exists. It saves the
generated data to a specified directory for reuse and provides progress
updates.
...
- cell_size:
  ...
  An integer specifying the cell size for the prediction grid in meters
  (default is 5000).
...
- output_dir:
  ...
  A string specifying the directory where the predictors data file
