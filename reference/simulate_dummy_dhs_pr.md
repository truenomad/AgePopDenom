...
- urban_proportion:
  ...
  Numeric. Proportion of the population in urban areas. Default is
  0.602.

- lon_range:

  Numeric vector of length 2. Longitude bounds for simulation. Default
  is c(-16.802, -13.849).

- lat_range:

  Numeric vector of length 2. Latitude bounds for simulation. Default is
  c(13.149, 13.801).
...
- nsampled_range:
  ...
  Integer vector of length 2. Range of sample sizes per cluster. Default
  is c(180, 220).
